...
input_file = os.path.join("data", "stage3", "googleplaystore.csv")
output_file_test = os.path.join("data", "stage4", "test.csv")
output_file_train = os.path.join("data", "stage4", "train.csv")
